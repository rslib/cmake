...
Examples:
  ...
  rs_target_add_warnings(TARGET mylib)

  # Strict warnings for tests (warnings as errors)
  rs_target_add_warnings(TARGET mytest WERROR)

  # Extra pedantic warnings for development
  rs_target_add_warnings(TARGET mylib EXTRA_WARNINGS)
#]=]
function(rs_target_add_warnings)
  ...
  if(NOT WARN_TARGET)
    message(FATAL_ERROR "rs_target_add_warnings: TARGET is required")
  endif()
  ...
  if(NOT TARGET ${WARN_TARGET})
    message(
      FATAL_ERROR
      "rs_target_add_warnings: Target '${WARN_TARGET}' does not exist"
    )
  endif()
...
#]=]
function(rs_target_add_warnings_multi)
  set(options WERROR EXTRA_WARNINGS)
  set(oneValueArgs "")
  ...
  # Validate required arguments
  if(NOT WARN_TARGETS)
    message(FATAL_ERROR "rs_target_add_warnings_multi: TARGETS is required")
  endif()
  ...
  foreach(target ${WARN_TARGETS})
    rs_target_add_warnings(TARGET ${target} ${OPTIONS_LIST})
  endforeach()
endfunction()
